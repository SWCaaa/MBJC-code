...
def run(data,
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path("instances_val2017-4.json")) # annotations json
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp94/weights/best.pt', help='model.pt path(s)')
